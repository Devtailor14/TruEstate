        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                <div className="flex items-center gap-2 mb-1">
                    <span className="text-sm font-medium text-slate-500">Total units sold</span>
            ...
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                ...
                <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xs text-slate-400 font-medium">({data.length} SRs)</span>
                </div>
            </div>
            <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col">
                <div className="flex items-center gap-2 mb-1">
                ...
                <div className="flex items-baseline gap-2">
                    ...
                    <span className="text-xs text-slate-400 font-medium">({Math.floor(data.length * 0.45)} SRs)</span>
                </div>
            </div>
        </div>
    );
